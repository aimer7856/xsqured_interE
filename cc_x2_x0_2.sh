#!/bin/bash
#SBATCH --job-name=cc_x2_x0_2
#SBATCH --array=0-24                     # <-- adjust this based on line count - 2
#SBATCH --time=00:02:00
#SBATCH --mem=512M
#SBATCH --cpus-per-task=1
#SBATCH --output=logs_cc_x0_2/%x_%A_%a.out
#SBATCH --error=logs_cc_x0_2/%x_%A_%a.err
#SBATCH --mail-user=doyeon.k@unb.ca
#SBATCH --mail-type=ALL

mkdir -p logs_cc_x0_2
...
# Read parameter line
PARAM_FILE="param_list_cc_x0_2.txt"
