...
def main():
    ...
    root = "/Users/doyeonkim/OneDrive/Documents/Project1_Sanjeev/xsqured_interE_my1/results_final/results_x2_x0_5_Neig_256"
    panel_dir = os.path.join(root, "panels_all_modes_x0_5_Neig_256")
