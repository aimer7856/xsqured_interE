#!/bin/bash
#SBATCH --job-name=cq_x2_x0_2
#SBATCH --array=0-24                    # <-- adjust this based on line count - 2
#SBATCH --time=00:05:00
#SBATCH --mem=512M
#SBATCH --cpus-per-task=1
#SBATCH --output=logs_cq_x0_2/%x_%A_%a.out
#SBATCH --error=logs_cq_x0_2/%x_%A_%a.err
#SBATCH --mail-user=doyeon.k@unb.ca
#SBATCH --mail-type=ALL

mkdir -p logs_cq_x0_2
...
# Read parameter line
PARAM_FILE="param_list_cq_x0_2.txt"
...
OUT_DIR="results_x2_x0_2/${MODE}/${FILENAME}"
mkdir -p "$OUT_DIR"
